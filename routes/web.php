...
Route::get('/turnamen/mahjong/{id}/peserta', [PublicMahjongTournamentController::class, 'participants'])
    ->whereNumber('id')
    ->name('public.mahjong-tournaments.participants');
...
Route::get('/turnamen/mahjong/{id}/poin', [PublicMahjongTournamentController::class, 'groups'])
    ->whereNumber('id')
    ->name('public.mahjong-tournaments.scores.groups');
